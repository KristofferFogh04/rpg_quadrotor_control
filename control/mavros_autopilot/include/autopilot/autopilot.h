...
class AutoPilot {
 ...
 private:
  ...
  void cmdLoop();
  void poseEstimateCallback(const geometry_msgs::PoseStamped::ConstPtr& msg);
  void velocityEstimateCallback(const geometry_msgs::TwistStamped::ConstPtr& msg);
  ...
  geometry_msgs::TwistStamped temp_vel_estimate_;
  geometry_msgs::PoseStamped temp_pose_estimate_;
  ...
  bool pose_estimate_available_;
  bool velocity_estimate_available_;
