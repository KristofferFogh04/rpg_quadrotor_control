...
class PositionController {
 ...
 private:
  ...
  static constexpr double norm_thrust_const_ = 0.050164;
  static constexpr double norm_thrust_offset_ = 0.1412;

  const Eigen::Vector3d kGravity_ = Eigen::Vector3d(0.0, 0.0, -9.815);
};
